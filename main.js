 ...
 *  Layers d-l2 through d-l6 are <g> elements inside the fetched terrain SVG. Each moves at a different speed to create depth.
 *
 *  d-l1 is the light mode terrain layer and is always hidden in dark mode — it is intentionally excluded from this list.
 *
 *  Speed values are negative — layers move upward as user scrolls down, creating the illusion that far-away layers move slower.
 * ===================================================================== */

/**
 * Sets up ScrollTrigger parallax for the five terrain depth layers.
 * Each layer is null-guarded — if the terrain SVG hasn't loaded yet, getElementById returns null and the layer is silently skipped.
 */
